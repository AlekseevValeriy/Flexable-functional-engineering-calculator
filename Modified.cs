namespace FFEC
{
    ...
    internal static class CommonSDataParser
    {
        public static void CommonDisplayDataParse(JObject data, Control control)
        {
            ...
            control.Font = ExtractDataJson.BuildFont
                (
                isBold: data["Font"]["Bold"].Value<Boolean>(),
                isItalic: data["Font"]["Italic"].Value<Boolean>(),
                isStrikeout: data["Font"]["Strikeout"].Value<Boolean>(),
                isUnderline: data["Font"]["Underline"].Value<Boolean>(),
                familyName: data["Font"]["Name"].Value<String>(),
                emSize: data["Font"]["Size"].Value<Single>(),
                unit: (GraphicsUnit)Enum.Parse(typeof(GraphicsUnit), data["Font"]["Unit"].Value<String>()),
                gdiCharSet: data["Font"]["GdiCharSet"].Value<Byte>(),
                gdiVerticalFont: data["Font"]["GdiVerticalFont"].Value<Boolean>()
                );
